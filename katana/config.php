...
return [
    ...
    'projects_B' => [
        ...
        ['title' => 'DAO and Service layer', 'description' => "It's a simple DAO and Service layer for JEE Platform. All structure is done, you just need to create your models, services and daos.", 'job' => 'Backend Developer', 'period' => 'November 2015 – December 2015', 'url' => "https://github.com/sayfessyd/JAVA-projects/tree/master/event_manager"],
        ['title' => 'Akinator Clone', 'description' => "Akinator, the Web Genie is an internet game and mobile app based on Twenty Questions that attempts to determine which character the player is thinking. Technologies: ES2015", 'job' => 'Frontend Developer', 'period' => 'Decembre 2015 – January 2016', 'url' => "https://github.com/sayfessyd/WEB-projects/tree/master/akinator_clone"],
        ...
        ['title' => 'webapp-chart', 'description' => "The chart that describes possibilities of web technologies that i have tried during 4 years. [2014-2018]", 'job' => 'Web Developer', 'period' => 'December 2017', 'url' => "https://github.com/sayfessyd/webapp-chart"],
    ...
    'skills' => [
        ['title' => 'PHP7 & Laravel 5.x (+Lumen)', 'level' => '90%'],
