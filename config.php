...
return [
    ...
    'projects_A' => [
        ['title' => 'MessageMe', 'description' => "MessageMe is a social media script, the ONLY ONE of its kind based on anonymous messages and build on top of Laravel 5.4 with all possible features.", 'technologies' => 'Laravel 5.4 - Vue.js 2.x - jQuery 3.x - Bootstrap - EmojiOne', 'job' => 'Frontend / Backend Developer', 'period' => 'May 2018 – August 2018', 'url' => "https://codecanyon.net/item/messageme-laravel-anonymous-social-media-script/22280893", 'image' => 'lollipop2.png', 'type' => 'frontend backend'],
