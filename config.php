...
return [
    ...
    'skills' => [
        ...
        ['title' => 'ASP.NET Web API & Razor & WCF Service & Web Forms', 'level' => '60%', 'count' => '3', 'description' => 'ASP.NET is an open-source server-side web application framework designed for web development to produce dynamic web pages. Razor is an ASP.NET programming syntax used to create dynamic web pages.'],
        ...
        ['title' => 'Android Studio 3.x', 'level' => '60%', 'count' => '1', 'description' => "Android Studio is the official IDE for Google's Android operating system, built on JetBrains' IntelliJ IDEA software and designed specifically for Android development."],
