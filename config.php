...
return [
    ...
    'projects_B' => [
        ...
        ['title' => 'ISIHub', 'description' => "ISIHub is an android project built with android studio that connects with a backend part based on camunda. ", 'technologies' => 'Android', 'job' => 'Android Developer', 'period' => 'April 2018 – May 2018', 'url' => "https://github.com/sayfessyd/ISIHub", 'image' => 'isihub.png', 'type' => 'frontend'],
        ['title' => 'Article CRUD', 'description' => "It's a simple CRUD application that implements MVC and Repository patterns", 'technologies' => 'ASP.NET', 'job' => 'Frontend / Backend Developer', 'period' => 'April 2018 – May 2018', 'url' => "https://github.com/sayfessyd/VB-CS-projects/tree/master/%5BWebAPI%2BService%2BRepository%5D%20Article%20CRUD", 'image' => 'article.png', 'type' => 'frontend backend'],
    ],
    ...
    'skills' => [
        ...
        ['title' => 'ASP.NET MVC & Web API & Razor & WCF Services & Web Forms', 'level' => '60%', 'count' => '3', 'description' => 'ASP.NET is an open-source server-side web application framework designed for web development to produce dynamic web pages. Razor is an ASP.NET programming syntax used to create dynamic web pages.'],
