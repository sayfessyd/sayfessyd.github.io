...
return [
    ...
    'skills' => [
        ...
        ['title' => 'Android Studio 3.x', 'level' => '60%', 'count' => '1', 'description' => "Android Studio is the official integrated development environment (IDE) for Google's Android operating system, built on JetBrains' IntelliJ IDEA software and designed specifically for Android development."],
