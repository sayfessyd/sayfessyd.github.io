...
return [
    ...
    'skills' => [
        ...
        ['title' => 'Spring Framework & Hibernate ORM & JSF 2.0 & Struts 2', 'level' => '70%', 'count' => '3', 'description' => 'Spring is an application framework and inversion of control container for the Java platform. Hibernate ORM is an object-relational mapping tool. JSF is a Java specification for building component-based user interfaces for web applications.'],
        ['title' => 'ASP.NET Web API & Razor & WCF Services & Web Forms', 'level' => '60%', 'count' => '3', 'description' => 'ASP.NET is an open-source server-side web application framework designed for web development to produce dynamic web pages. Razor is an ASP.NET programming syntax used to create dynamic web pages.'],
        ...
        ['title' => 'Apache Cordova 5.x & OnsenUI 2', 'level' => '60%', 'count' => '1', 'description' => 'Apache Cordova (PhoneGap) is a mobile application development framework, it enables software programmers to build applications for mobile devices using web technologies.'],
        ['title' => 'Android Studio 3.0', 'level' => '60%', 'count' => '1', 'description' => "Android Studio is the official IDE for Google's Android operating system, built on JetBrains' IntelliJ IDEA software and designed specifically for Android development, it provides the fastest tools for building apps."],
