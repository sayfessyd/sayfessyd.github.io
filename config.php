...
return [
    ...
    'projects_B' => [
        ...
        ['title' => 'Prestashop Booster', 'description' => "Turn prestashop based websites much faster by deleting worthless data.", 'technologies' => 'PHP5 - Smarty - jQuery', 'job' => 'Frontend / Backend Developer', 'period' => 'July 2017 – August 2017', 'url' => "#", 'image' => 'prestashop.png', 'type' => 'frontend'],
    ...
    'top_skills' => [
        ['title' => 'PHP7 & Laravel 5.x (+Lumen)', 'level' => '90%', 'description' => 'PHP is a server-side scripting language designed for web development. Laravel is a web application framework with expressive, elegant syntax. Lumen is the stunningly fast PHP micro-framework by Laravel.'],
        ['title' => 'ES6 & Vue.js 2.x (+Nuxt.js)', 'level' => '80%', 'description' => ' ES6, also known as ES2015, is the latest version of the ECMAScript standard. Vue.js is an open-source progressive JavaScript framework for building user interfaces. Nuxt.js is a framework for server-rendered Vue applications.'],
        ['title' => 'ES5 & jQuery (+Mobile) & AngularJS 1.x', 'level' => '80%', 'description' => 'jQuery is a JavaScript library designed to simplify the client-side scripting of HTML. AngularJS is a JavaScript-based front-end web application framework mainly maintained by Google.'],
    ],

    'skills' => [
        ['title' => 'HTML5 & CSS3 & CSSnext', 'level' => '70%', 'description' => 'HTML is a markup language used for structuring and presenting content on the World Wide Web. CSS is a style sheet language used for describing the presentation of a document written in a markup language.'],
        ['title' => 'Bootstrap 4 & Foundation 5 & PrimeFaces 5 & Bulma 0.x & TailwindCSS 0.x', 'level' => '70%', 'description' => 'Top 5 Most Popular CSS and UI Frameworks. A CSS framework is a pre-prepared software framework to allow easier and more standards-compliant web design using the CSS language.'],
        ['title' => 'Yarn & Gulp & Webpack', 'level' => '70%', 'description' => 'Yarn is a fast, reliable, and secure dependency management. Gulp is a toolkit to automate time-consuming tasks in the development workflow. Webpack is a module bundler.'],
        ['title' => 'Pug (Jade) & Stylus & Sass', 'level' => '70%', 'description' => 'Pug is a high-performance template engine heavily influenced by Haml. Stylus is a revolutionary new language, providing an efficient, dynamic, and expressive way to generate CSS. Sass is a scripting language that is interpreted or compiled into CSS.'],
        ['title' => 'Spring Framework & Hibernate ORM & JSF 2.0', 'level' => '70%', 'description' => 'Spring is an application framework and inversion of control container for the Java platform. Hibernate ORM is an object-relational mapping tool. JSF is a Java specification for building component-based user interfaces for web applications.'],
        ['title' => 'ASP.NET Web API & Razor & Web Forms', 'level' => '60%', 'description' => 'ASP.NET is an open-source server-side web application framework designed for web development to produce dynamic web pages. Razor is an ASP.NET programming syntax used to create dynamic web pages.'],
        ['title' => 'Express.js & Socket.io', 'level' => '60%', 'description' => 'Express.js, or simply Express, is a web application framework for Node.js. Socket.IO is a JavaScript library for realtime web applications,  it enables bi-directional communication.'],
        ['title' => 'Prestashop 1.7', 'level' => '60%', 'description' => 'Prestashop is an open source e-commerce solution, it is written in the PHP programming language with support for the MySQL database management system.'],
        ['title' => 'Apache Cordova 5.x', 'level' => '60%', 'description' => 'Apache Cordova (PhoneGap) is a mobile application development framework, it enables software programmers to build applications for mobile devices using web technologies.'],
        ['title' => 'Ableton Live 9.x & Kontakt 5.x', 'level' => '60%', 'description' => 'Ableton Live is a software music sequencer and digital audio workstation for macOS and Windows. Kontakt is the world’s leading software sampler, a playground for working creatively with samples.'],
        ['title' => 'Adobe Photoshop & After Effects CS6', 'level' => '60%', 'description' => 'Adobe Photoshop is a raster graphics editor developed and published by Adobe Systems for macOS and Windows. Adobe After Effects is a digital visual effects, and compositing application.']
