...
return [
    ...
    'about' => "I have worked on several projects since June 2014 as a self-employed full stack developer trying to enhance my own skills and discover many technologies, especially the web's ecosystem which still growing day by day until now. I am the author of an image editor called Lollipop that has reached over 175 sales on CodeCanyon as a 5-star product, and also many other projects. I plan to integrate big companies in the world as a software engineer after graduating.",
    'tel' => "+216.50.465.281",
